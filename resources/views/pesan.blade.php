                ...
                <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-md-66">
                                <div class="form-floating">
                                    <input type="email" class="form-control" id="nohp" placeholder="Your Email">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="delivery-option" id="delivery" value="delivery" checked>
                                <label class="form-check-label" for="delivery">Pesan Antar</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="delivery-option" id="pickup" value="pickup">
                                <label class="form-check-label" for="pickup">Ambil Sendiri</label>
                            </div>
                            <div class="col-12">
