        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Pesan Antar </h1>
                </div>
            </div>
        </div>
        <!-- Navbar & Hero End -->
            ...
            <div class="row g-0">
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <center>
                            <h1 class="text-white mb-4">Pesan Antar Sekarang!</h1>
                        </center>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-66">
                                ...
                                <div class="col-md-66">
                                    <div class="form-floating date" id="date4" data-target-input="nearest">
                                        <input type="time" class="form-control datetimepicker-input"
                                            id="datetime" placeholder="Time" data-target="#date4"
                                            data-toggle="datetimepicker" />
                                        <label for="time">Waktu Pengantaran</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Special Request" id="message" style="height: 100px"></textarea>
                                        <label for="message">Catatan untuk Kurir</label>
                                    </div>
                                </div>
                                <div class="form-floating">
                                ...
                                <div class="form-floating">
                                    ...
                                    <label for="payment-method">Pilih Layanan</label>
                                </div>

                                    <!-- Kolom Pesanan -->
                                    <h4 class="mt-4">Pilih Menu</h4>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="menu1"
                                            name="menu" value="Bakso Kuah">
                                        <label class="form-check-label" for="menu1">Bakso Kuah</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="menu2"
                                            name="menu" value="Bakso Goreng">
                                        <label class="form-check-label" for="menu2">Bakso Goreng</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="menu3"
                                            name="menu" value="Es Teh Manis">
                                        <label class="form-check-label" for="menu3">Es Teh Manis</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="menu4"
                                            name="menu" value="Es Jeruk">
                                        <label class="form-check-label" for="menu4">Es Jeruk</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="menu5"
                                            name="menu" value="Topping Keju">
                                        <label class="form-check-label" for="menu5">Topping Keju</label>
                                    </div>
